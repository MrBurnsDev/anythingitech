          ...
          <form onSubmit={onSubmit} className="lg:col-span-7 bg-card border border-border rounded-xl p-8 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input id="name" required className="h-12 rounded-md bg-background" placeholder="Jane Smith" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="email" className="text-xs uppercase tracking-[0.18em] text-muted-foreground">Email</Label>
                <Input id="email" type="email" required className="h-12 rounded-md bg-background" placeholder="jane@example.com" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="phone" className="text-xs uppercase tracking-[0.18em] text-muted-foreground">Phone</Label>
                <Input id="phone" className="h-12 rounded-md bg-background" placeholder="(508) 555 0123" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="town" className="text-xs uppercase tracking-[0.18em] text-muted-foreground">Town</Label>
                <Input id="town" className="h-12 rounded-md bg-background" placeholder="Edgartown" />
              </div>
            </div>

            <div className="space-y-2 mt-6">
              <Label htmlFor="type" className="text-xs uppercase tracking-[0.18em] text-muted-foreground">Project Type</Label>
              <select id="type" className="h-12 w-full rounded-md border border-input bg-background px-3 text-sm">
            ...
            <div className="space-y-2 mt-6">
              ...
              <Textarea id="message" rows={6} className="rounded-md bg-background resize-none" placeholder="A few sentences about what you'd like help with..." />
            </div>
