-- Resolve Unknown Businesses (FINAL)
-- Generated: 2026-04-27T01:45:35.040Z
--
-- This is the final reviewed migration ready for production.
-- Includes:
--   - 40 approved records (passed sanity review)
--   - 11 corrected records (with fixes applied)
-- Excludes:
--   - 12 records needing manual review
--   - 0 invalid records
--
...
-- ============================================================
-- CORRECTED RECORDS (11)
-- These had issues that have been fixed
-- ============================================================
UPDATE businesses SET town = 'Vineyard Haven', full_address = '12 State Rd, Vineyard Haven, MA 02568', category = 'Restaurant', business_name = 'La Choza' WHERE id = 204; -- The La Choza Difference: Flavo → La Choza
UPDATE businesses SET town = 'West Tisbury', full_address = '94 North Rd, West Tisbury, MA 02575', category = 'Community', business_name = 'Native Earth Teaching Farm' WHERE id = 231; -- Native Earth Teaching Farm → Native Earth Teaching Far
UPDATE businesses SET town = 'Chilmark', full_address = '56 Basin Rd, Menemsha, MA 02552', category = 'Shopping & Retail', business_name = 'Larsen''s Fish Market' WHERE id = 253; -- Larsen → Larsen's Fish Market
UPDATE businesses SET town = 'Chilmark', full_address = '54 Basin Rd, Menemsha, MA 02552', category = 'Shopping & Retail', business_name = 'Menemsha Fish Market' WHERE id = 255; -- Menemsha Fish Market → Menemsha Fish Market
UPDATE businesses SET town = 'Vineyard Haven', full_address = 'Vineyard Haven, MA', category = 'Community', business_name = 'MV Narcotics Anonymous' WHERE id = 348; -- Mvana → MV Narcotics Anonymous
UPDATE businesses SET town = 'Vineyard Haven', full_address = '14 Beach St, Vineyard Haven, MA 02568', category = 'Shopping & Retail', business_name = 'Chicken Alley' WHERE id = 483; -- Chickenalley → Chicken Alley
UPDATE businesses SET town = 'Edgartown', full_address = '20 Robinson Rd, Edgartown, MA 02539', category = 'Community', business_name = 'Edgartown Council on Aging' WHERE id = 512; -- The Edgartown Council on Aging → Edgartown Council on Agin
UPDATE businesses SET town = 'Edgartown', full_address = '256 Upper Main St, Edgartown, MA 02539', category = 'Shopping & Retail', business_name = 'Fine Fettle Dispensary' WHERE id = 520; -- Fine Fettle → Fine Fettle Dispensary
UPDATE businesses SET town = 'Edgartown', full_address = '141 Main St, Edgartown, MA 02539', category = 'Shopping & Retail', business_name = 'Larry''s Tackle Shop' WHERE id = 549; -- Larry → Larry's Tackle Shop
UPDATE businesses SET town = 'Edgartown', full_address = '38 Winter St, Edgartown, MA 02539', category = 'Health & Wellness', business_name = 'Revive by Sarka' WHERE id = 597; -- Revive by Sarka ~ European Ski → Revive by Sarka
UPDATE businesses SET town = 'West Tisbury', full_address = '688 State Rd, West Tisbury, MA 02575', category = 'Restaurant', business_name = 'Model Deli' WHERE id = 729; -- Model Deli Is a Model of Delic → Model Deli

-- ============================================================
-- EXCLUDED: NEEDS MANUAL REVIEW (12)
-- These records are NOT included in this migration
-- ============================================================
-- ID 206: Mikado (Vague name needs verification: Mikado → Mikado?...)
-- ID 295: Louisa Gould Photographer (Possibly truncated: Louisa Gould Gallery (original...)
-- ID 326: The Vineyard's Drive (Possibly truncated: Drive-In MV (original: The Vin...)
-- ID 351: Airportfitness (Vague name needs verification: Airportfitness → Ai...)
-- ID 355: Crossfitmarthas (Vague name needs verification: Crossfitmarthas → C...)
-- ID 472: Brunos (Vague name needs verification: Bruno's → Bruno's?...)
-- ID 478: Cb Stark Jewelers (Vague name needs verification: Cb Stark Jewelers →...)
-- ID 540: Jardin Mahoney (Vague name needs verification: Jardin Mahoney → Ja...)
-- ID 608: Sea Legs (Vague name needs verification: Sea Legs → Sea Legs...)
-- ID 618: Slip 77 (Vague name needs verification: Slip 77 → Slip 77 P...)
-- ID 623: Sole (Vague name needs verification: Sole → Sole Boutiqu...)
-- ID 665: Sail Surf and Paddle on Martha's Vineyard (Possibly truncated: Wind's Up (original: Sail Surf...)

COMMIT;

-- Migration complete. Total records updated: 51
